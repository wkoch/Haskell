...
convert s = s
    ...
    & T.lines
    & map (T.words)
    & map (\line -> map (\value -> textToInt value) line)
...
-- perpendicular :: Mtx.Matrix Int -> Int -> Int -> [(Int,[Int])] -> (Int,[Int])
-- perpendicular mtx n count acc = maximum acc
-- perpendicular mtx n count acc =
--     newAcc = acc ++ [((product $ take n mtx), take n mtx)]
--     if Mtx.nrows

-- horizontally :: Int -> Mtx.Matrix Int -> (Int,[Int])
-- horizontally n xs =
--     xs
--     & perpendicular mtx n []

-- vertically :: Int -> Mtx.Matrix Int -> (Int,[Int])
-- vertically n mtx =
--     xs
--     & perpendicular mtx n []
